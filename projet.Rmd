...
```
**Graphique n°1)** représentant l'évolution de la note moyenne en fonction du nombre d'applications.
...
```
**Graphique n°2)** représentant l'évolution de la note moyenne en fonction du nombre de notes.
...
app %>%
  ...
  geom_smooth(method = "auto",color="red")
```
**Graphique n°3)** représentant l'évolution de la note moyenne lorsqu'il ya peu de note.
...
```
**Graphique n°4)** représentant l'évolution de la note moyenne en fonction du prix.
...
```
**Graphique n°5)** représentant l'évolution de la note moyenne en fonction du genre principal de l'application.
...
app %>%
  ...
  geom_histogram(binwidth = 0.25) + ylab("nbApplication")
```
**Graphique n°6)** représentant l'évolution de la note moyenne en fonction du prix des achats in-app.
...
```
**Graphique n°7)** représentant l'évolution de la note moyenne en fonction de l'âge recommandé.
...
```
**Graphique n°8)** représentant l'évolution de la note moyenne en fonction du prix nombre de langues disponibles.
